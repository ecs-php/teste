...
```bash
$ cd module
$ git clone https://github.com/zendframework/Api MyNewModule
$ cd MyNewModule
```
...
`src/Controller/ApiController.php`, and replace any occurence of
`Api` with your new namespace.
...
> > sed --in-place -e 's/Api/MyNewModule/g' $php
> > done
> ```
